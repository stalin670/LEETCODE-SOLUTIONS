<h2><a href="https://leetcode.com/problems/maximum-subarray-xor-with-bounded-range">4204. Maximum Subarray XOR with Bounded Range</a></h2><h3>Hard</h3><hr><p>You are given a non-negative integer array <code>nums</code> and an integer <code>k</code>.</p>
